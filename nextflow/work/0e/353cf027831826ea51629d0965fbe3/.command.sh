...
mkdir -p Lemon_out ModuleViewer_files Preprocessing
...
for file in Metabolites.selected_regs_list.txt Metabolites.selected_regulators_scores.txt clusters_list.txt hPTMs.selected_regs_list.txt hPTMs.selected_regulators_scores.txt sample_mapping.mvf; do
