...
python3 $SCRIPT_PATH         --input_dir .         --output_dir .         --run_id minW0p15         --coherence_threshold "0.5"         --regulator_selection_method "fold_per_module"         --top_n_percent_regulators "2.0"         --regulator_fold_cutoff "2.0"         --regulator_types "hPTMs:Histone_proteomics.csv,Metabolites:metabolomics_combined.csv"
