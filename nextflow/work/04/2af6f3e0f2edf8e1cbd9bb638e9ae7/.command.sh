...
Rscript $SCRIPT_PATH \
    ...
    --top_n_genes "5000"         --perform_TFA "true"         --use_omics_specific_scaling "true"         --DESeq_contrast1 "diagnosis"         --design_formula "~ diagnosis"         --metadata_columns "diagnosis"         --expression_col "count"         --sample_id_col "Sample_ID"         --organism "human"         $([ ! -z "$PRIOR_NETWORK" ] && echo "--prior_network $PRIOR_NETWORK")
