...
bash $SCRIPT_PATH         "hPTMs:Histone_proteomics.csv,Metabolites:metabolomics_combined.csv"         "/home/borisvdm/repo/LemonIte/nextflow/LemonTree/lemontree_v3.1.1.jar"         .         "human"         "0.15"
