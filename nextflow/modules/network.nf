process POST_CLUSTERING {
    ...
    bash \$SCRIPT_PATH \
        ...
        . \
        "${params.organism}" \
        "${params.lemontree_tight_min_weight}"
...
process NETWORK_GENERATION {
    ...
    touch Networks/hPTMs2targets_stub.txt
    touch Networks/LemonNetwork_stub.txt
    touch Networks/Cytoscape_stub.txt
    touch Networks/specific_modules.txt
...
process SUBNETWORK_GRAPHS {
    ...
    output:
    path "Networks/subnetworks_graphviz/graph_*_graphviz.png", emit: subnetwork_graphs_graphviz, optional: true
    path "Networks/subnetworks_graphviz/graph_*_graphviz.pdf", emit: subnetwork_pdfs, optional: true
    path "Networks/subnetworks_graphviz/legend.png", emit: legend_png, optional: true
    path "Networks/subnetworks_graphviz/legend.pdf", emit: legend_pdf, optional: true
    ...
    stub:
    """
    mkdir -p Networks/subnetworks_graphviz
    touch Networks/subnetworks_graphviz/graph_0_graphviz.png
    touch Networks/subnetworks_graphviz/graph_0_graphviz.pdf
    touch Networks/subnetworks_graphviz/legend.png
    touch Networks/subnetworks_graphviz/legend.pdf
    """
}
